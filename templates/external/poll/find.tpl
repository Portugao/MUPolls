{* Purpose of this template: Display a popup selector of polls for scribite integration *}
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="{lang}" lang="{lang}">
<head>
    <title>{gt text='Search and select poll'}</title>
...
<body>
    ...
    <div>
        ...
        <fieldset>
            <legend>{gt text='Search and select poll'}</legend>

            <div class="z-formrow">
                <label for="mUPollsPasteAs">{gt text='Paste as'}:</label>
                <select id="mUPollsPasteAs" name="pasteas">
                    <option value="1">{gt text='Link to the poll'}</option>
                    <option value="2">{gt text='ID of poll'}</option>
                </select>
            </div>
            <br />

            <div class="z-formrow">
                <label for="mUPollsObjectId">{gt text='Poll'}:</label>
