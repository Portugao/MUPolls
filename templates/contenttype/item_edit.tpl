...
<div style="margin-left: 80px">
    <div class="z-formrow">
        {formlabel for='mUPollsObjectType' __text='Object type'}
            {mupollsObjectTypeSelector assign='allObjectTypes'}
            {formdropdownlist id='mUPollsObjectType' dataField='objectType' group='data' mandatory=true items=$allObjectTypes}
    ...
    <div{* class="z-formrow"*}>
        ...
        {mupollsItemSelector id='id' group='data' objectType=$objectType}
    </div>
