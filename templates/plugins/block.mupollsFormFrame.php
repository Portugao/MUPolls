...
/**
 * The mupollsFormFrame plugin adds styling <div> elements and a validation summary.
 *
 ...
 */
function smarty_block_mupollsFormFrame($params, $content, $view)
{
    ...
    $result .= $view->registerBlock('MUPolls_Form_Plugin_FormFrame', $params, $content);
