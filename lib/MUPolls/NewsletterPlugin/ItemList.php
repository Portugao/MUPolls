 ...
 */
class MUPolls_NewsletterPlugin_ItemList extends Newsletter_AbstractPlugin
{
    /**
    ...
    {
        return $this->__('Latest MUPolls items');
    }
    ...
    {
        return $this->__('List of polls and other MUPolls items');
    }
    ...
    {
        return $this->__('This plugin shows a list of polls and other items of the MUPolls module.');
    }
    ...
    {
        $objectTypes = array();
        if ($this->pluginAvailable() && ModUtil::loadApi($this->modname)) {
            $objectTypes['option'] = array('name' => $this->__('Options'));
            $objectTypes['poll'] = array('name' => $this->__('Polls'));
            $objectTypes['vote'] = array('name' => $this->__('Votes'));
        }
