 ...
 */
abstract class MUPolls_Util_Base_AbstractListEntries extends Zikula_AbstractBase
{
    /**
    ...
    public function getEntries($objectType, $fieldName)
    {
        ...
        switch ($objectType) {
            case 'option':
                switch ($fieldName) {
                    case 'workflowState':
                        $entries = $this->getWorkflowStateEntriesForOption();
                        break;
                }
                break;
            case 'poll':
                switch ($fieldName) {
                    case 'workflowState':
                        $entries = $this->getWorkflowStateEntriesForPoll();
                        break;
                }
                break;
            case 'vote':
                switch ($fieldName) {
                    case 'workflowState':
                        $entries = $this->getWorkflowStateEntriesForVote();
                        break;
                }
                break;
        }
     ...
     * @return array Array with desired list entries
     */
    public function getWorkflowStateEntriesForOption()
    {
        $states = array();
        $states[] = array(
            'value'   => 'approved',
     ...
     * @return array Array with desired list entries
     */
    public function getWorkflowStateEntriesForVote()
    {
        $states = array();
        $states[] = array(
            'value'   => 'approved',
