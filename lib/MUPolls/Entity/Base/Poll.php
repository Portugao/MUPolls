 ...
 * @abstract
 */
abstract class MUPolls_Entity_Base_Poll extends Zikula_EntityAccess
{
    /**
    ...
    /**
     * @var MUPolls_Entity_Validator_Poll The validator for this entity.
     */
     ...
     * Gets the _validator.
     *
     * @return MUPolls_Entity_Validator_Poll
     */
     ...
     * Sets the _validator.
     *
     * @param MUPolls_Entity_Validator_Poll $_validator.
     *
     * @return void
     */
    public function set_validator(MUPolls_Entity_Validator_Poll $_validator = null)
    {
     ...
     *
     * @see MUPolls_Entity_Poll::postLoadCallback()
     ...
     *
     * @see MUPolls_Entity_Poll::prePersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - no access to entity manager or unit of work apis
     *
     * @see MUPolls_Entity_Poll::postPersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see MUPolls_Entity_Poll::preRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - will not be called for a DQL DELETE statement
     *
     * @see MUPolls_Entity_Poll::postRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - no creation of other entities allowed
     *
     * @see MUPolls_Entity_Poll::preUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - will not be called for a DQL UPDATE statement
     *
     * @see MUPolls_Entity_Poll::postUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see MUPolls_Entity_Poll::preSaveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     * For more information see corresponding callback handlers.
     *
     * @see MUPolls_Entity_Poll::postSaveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @return MUPolls_Entity_Validator_Poll The validator for this entity.
     */
    public function initValidator()
    {
        ...
        $this->_validator = new MUPolls_Entity_Validator_Poll($this);
    ...
    protected function prepareItemActions()
    {
        ...
        $currentFunc = FormUtil::getPassedValue('func', 'main', 'GETPOST', FILTER_SANITIZE_STRING);
        $component = 'MUPolls:Poll:';
        $instance = $this->id . '::';
        $dom = ZLanguage::getModuleDomain('MUPolls');
        if ($currentLegacyControllerType == 'admin') {
            if (in_array($currentFunc, array('main', 'view'))) {
                $this->_actions[] = array(
                    'url' => array('type' => 'user', 'func' => 'display', 'arguments' => array('ot' => 'poll', 'id' => $this['id'])),
                    'icon' => 'preview',
                    'linkTitle' => __('Open preview page', $dom),
                    'linkText' => __('Preview', $dom)
                );
                $this->_actions[] = array(
                    'url' => array('type' => 'admin', 'func' => 'display', 'arguments' => array('ot' => 'poll', 'id' => $this['id'])),
                    'icon' => 'display',
            ...
            if (in_array($currentFunc, array('main', 'view', 'display'))) {
                if (SecurityUtil::checkPermission($component, $instance, ACCESS_EDIT)) {
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'edit', 'arguments' => array('ot' => 'poll', 'id' => $this['id'])),
                        'icon' => 'edit',
                        'linkTitle' => __('Edit', $dom),
                        'linkText' => __('Edit', $dom)
                    );
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'edit', 'arguments' => array('ot' => 'poll', 'astemplate' => $this['id'])),
                        'icon' => 'saveas',
                ...
                if (SecurityUtil::checkPermission($component, $instance, ACCESS_DELETE)) {
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'delete', 'arguments' => array('ot' => 'poll', 'id' => $this['id'])),
                        'icon' => 'delete',
            ...
            if ($currentFunc == 'display') {
                $this->_actions[] = array(
                    'url' => array('type' => 'admin', 'func' => 'view', 'arguments' => array('ot' => 'poll')),
                    'icon' => 'back',
        ...
        if ($currentLegacyControllerType == 'user') {
            ...
            if (in_array($currentFunc, array('main', 'view', 'display'))) {
                if (SecurityUtil::checkPermission($component, $instance, ACCESS_EDIT)) {
                    $this->_actions[] = array(
                        'url' => array('type' => 'user', 'func' => 'edit', 'arguments' => array('ot' => 'poll', 'id' => $this['id'])),
                        'icon' => 'edit',
                        'linkTitle' => __('Edit', $dom),
                        'linkText' => __('Edit', $dom)
                    );
                    $this->_actions[] = array(
                        'url' => array('type' => 'user', 'func' => 'edit', 'arguments' => array('ot' => 'poll', 'astemplate' => $this['id'])),
                        'icon' => 'saveas',
                        'linkTitle' => __('Reuse for new item', $dom),
                        'linkText' => __('Reuse', $dom)
                    );
                ...
                if (SecurityUtil::checkPermission($component, $instance, ACCESS_DELETE)) {
                    $this->_actions[] = array(
                        'url' => array('type' => 'user', 'func' => 'delete', 'arguments' => array('ot' => 'poll', 'id' => $this['id'])),
                        'icon' => 'delete',
                        'linkTitle' => __('Delete', $dom),
                        'linkText' => __('Delete', $dom)
                    );
            ...
            if ($currentFunc == 'display') {
                $this->_actions[] = array(
                    'url' => array('type' => 'user', 'func' => 'view', 'arguments' => array('ot' => 'poll')),
                    'icon' => 'back',
                    'linkTitle' => __('Back to overview', $dom),
                    'linkText' => __('Back to overview', $dom)
                );
