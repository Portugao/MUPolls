 ...
 * @abstract
 */
abstract class MUPolls_Entity_Base_AbstractOption extends Zikula_EntityAccess
{
    /**
            ...
            if (in_array($currentFunc, array('main', 'view'))) {
                $this->_actions[] = array(
                    'url' => array(
                        'type' => 'user',
                        'func' => 'display',
                        'arguments' => array('ot' => 'option', 'id' => $this['id'])
                    ),
                    'icon' => 'preview',
                ...
                if (SecurityUtil::checkPermission($component, $instance, ACCESS_EDIT)) {
                    ...
                    $this->_actions[] = array(
                        'url' => array(
                            'type' => 'admin',
                            'func' => 'edit',
                            'arguments' => array('ot' => 'option', 'astemplate' => $this['id'])
                        ),
                        'icon' => 'saveas',
