 ...
 */
class MUPolls_Entity_Poll extends MUPolls_Entity_Base_Poll
{
     ...
     * @ORM\PrePersist
     * @ORM\PreUpdate
     * @see MUPolls_Entity_Poll::performPreSaveCallback()
     * @return void.
     */
     ...
     * @ORM\PostPersist
     * @ORM\PostUpdate
     * @see MUPolls_Entity_Poll::performPostSaveCallback()
     * @return void.
     */
