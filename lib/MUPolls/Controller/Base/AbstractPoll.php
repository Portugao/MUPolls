 ...
 */
abstract class MUPolls_Controller_Base_AbstractPoll extends Zikula_AbstractController
{
    /**
     * Post initialise.
     *
    ...
    public function main()
    {
        ...
        $objectType = 'poll';
        $utilArgs = array('controller' => 'poll', 'action' => 'index');
        ...
        if ($legacyControllerType == 'admin') {
            ...
            $redirectUrl = ModUtil::url($this->name, 'poll', 'view', array('lct' => $legacyControllerType));
        ...
        $this->view->setCacheId('poll_main');
        
        // return main template
        return $this->view->fetch('poll/main.tpl');
    }
    /**
    ...
    public function edit()
    {
        ...
        // parameter specifying which type of objects we are treating
        $objectType = 'poll';
        $utilArgs = array('controller' => 'poll', 'action' => 'edit');
        ...
        $handlerClass = $this->name . '_Form_Handler_Poll_Edit';
    ...
    public function delete()
    {
        ...
        // parameter specifying which type of objects we are treating
        $objectType = 'poll';
        $utilArgs = array('controller' => 'poll', 'action' => 'delete');
        ...
        if (!$deleteAllowed) {
            return LogUtil::registerError($this->__('Error! It is not allowed to delete this poll.'));
        }
        ...
        if ($confirmation) {
            ...
            if ($validationHooksPassed) {
                ...
                // The poll was deleted, so we clear all cached pages this item.
    ...
    public function adminHandleSelectedEntries()
    {
        ...
        foreach ($items as $itemid) {
            ...
            if ($action != 'delete') {
                ...
                $url = new Zikula_ModUrl($this->name, 'poll', 'display', ZLanguage::getLanguageCode(), $urlArgs);
            }
        ...
        $redirectUrl = ModUtil::url($this->name, 'admin', 'main', array('ot' => 'poll'));
