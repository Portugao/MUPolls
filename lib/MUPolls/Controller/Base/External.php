 ...
 */
class MUPolls_Controller_Base_External extends Zikula_AbstractController
{
    /**
     * Post initialise.
     *
    ...
    public function finder()
    {
        ...
        $objectType = $getData->filter('objectType', 'poll', FILTER_SANITIZE_STRING);
        $utilArgs = array('controller' => 'external', 'action' => 'finder');
        if (!in_array($objectType, $controllerHelper->getObjectTypes('controller', $utilArgs))) {
            $objectType = $controllerHelper->getDefaultObjectType('controllerType', $utilArgs);
        }
        
        $this->throwForbiddenUnless(SecurityUtil::checkPermission('MUPolls:' . ucfirst($objectType) . ':', '::', ACCESS_COMMENT), LogUtil::getErrorMsgPermission());
