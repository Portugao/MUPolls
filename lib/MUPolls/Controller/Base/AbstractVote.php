 ...
 */
abstract class MUPolls_Controller_Base_AbstractVote extends Zikula_AbstractController
{
    /**
     * Post initialise.
     *
    ...
    public function main()
    {
        ...
        $objectType = 'vote';
        $utilArgs = array('controller' => 'vote', 'action' => 'index');
        ...
        if ($legacyControllerType == 'admin') {
            ...
            $redirectUrl = ModUtil::url($this->name, 'vote', 'view', array('lct' => $legacyControllerType));
        ...
        $this->view->setCacheId('vote_main');
        
        // return main template
        return $this->view->fetch('vote/main.tpl');
    }
    /**
    ...
    public function view()
    {
        ...
        // parameter specifying which type of objects we are treating
        $objectType = 'vote';
        $utilArgs = array('controller' => 'vote', 'action' => 'view');
        ...
        $currentUrlObject = new Zikula_ModUrl($this->name, 'vote', 'view', ZLanguage::getLanguageCode(), $currentUrlArgs);
    ...
    public function display()
    {
        ...
        // parameter specifying which type of objects we are treating
        $objectType = 'vote';
        $utilArgs = array('controller' => 'vote', 'action' => 'display');
        $permLevel = $legacyControllerType == 'admin' ? ACCESS_ADMIN : ACCESS_READ;
        $this->throwForbiddenUnless(SecurityUtil::checkPermission($this->name . ':' . ucfirst($objectType) . ':', '::', $permLevel), LogUtil::getErrorMsgPermission());
        $entityClass = $this->name . '_Entity_' . ucfirst($objectType);
        $repository = $this->entityManager->getRepository($entityClass);
        ...
        $currentUrlObject = new Zikula_ModUrl($this->name, 'vote', 'display', ZLanguage::getLanguageCode(), $currentUrlArgs);
    ...
    public function adminHandleSelectedEntries()
    {
        ...
        foreach ($items as $itemid) {
            ...
            if ($action != 'delete') {
                ...
                $url = new Zikula_ModUrl($this->name, 'vote', 'display', ZLanguage::getLanguageCode(), $urlArgs);
            }
        ...
        $redirectUrl = ModUtil::url($this->name, 'admin', 'main', array('ot' => 'vote'));
