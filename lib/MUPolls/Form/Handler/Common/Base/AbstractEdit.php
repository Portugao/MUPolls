 ...
 */
abstract class MUPolls_Form_Handler_Common_Base_AbstractEdit extends Zikula_Form_AbstractHandler
{
    /**
    ...
    public function initialize(Zikula_Form_View $view)
    {
        ...
        $controllerHelper = new MUPolls_Util_Controller($this->view->getServiceManager());
    ...
    protected function initTranslationsForEditing()
    {
        ...
        $translatableHelper = new MUPolls_Util_Translatable($this->view->getServiceManager());
    ...
    public function handleCommand(Zikula_Form_View $view, &$args)
    {
        ...
        if ($entity->supportsHookSubscribers() && $action != 'cancel') {
            $hookHelper = new MUPolls_Util_Hook($this->view->getServiceManager());
    ...
    protected function writeRelationDataToEntity_rec($entity, $entityData, $plugins)
    {
        foreach ($plugins as $plugin) {
            if ($plugin instanceof MUPolls_Form_Plugin_AbstractObjectSelector && method_exists($plugin, 'assignRelatedItemsToEntity')) {
    ...
    {
        foreach ($plugins as $plugin) {
            if ($plugin instanceof MUPolls_Form_Plugin_AbstractObjectSelector && method_exists($plugin, 'persistRelatedItems')) {
