 ...
 */
class MUPolls_Form_Plugin_Base_UserInput extends Zikula_Form_Plugin_TextInput
{
    /**
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        $result = '<div id="' . $this->getId() . 'LiveSearch" class="mupolls-livesearch-user mupolls-autocomplete-user z-hide">
