 ...
 */
class MUPolls_Form_Plugin_Base_AbstractItemSelector extends Zikula_Form_Plugin_TextInput
{
    /**
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        if ($firstTime) {
            ...
            PageUtil::addVar('javascript', 'modules/MUPolls/javascript/MUPolls_finder.js');
            PageUtil::addVar('stylesheet', ThemeUtil::getModuleStylesheet('MUPolls'));
        }
        $firstTime = false;

        if (!SecurityUtil::checkPermission('MUPolls:' . ucfirst($this->objectType) . ':', '::', ACCESS_COMMENT)) {
            return false;
        }
    ...
    {
        parent::decode($view);
        $this->objectType = FormUtil::getPassedValue('MUPolls_objecttype', 'poll', 'POST');
        $this->selectedItemId = $this->text;
    }
}
