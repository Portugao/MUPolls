 ...
 */
abstract class MUPolls_Listener_Base_AbstractUser
{
    /**
    ...
    public static function delete(Zikula_Event $event)
    {
        ...
        $repo = $entityManager->getRepository('MUPolls_Entity_Option');
        ...
        $repo = $entityManager->getRepository('MUPolls_Entity_Poll');
        ...
        $repo = $entityManager->getRepository('MUPolls_Entity_Vote');
