 ...
 */
class MUPolls_Listener_Base_ThirdParty
{
    ...
    public static function getEditorHelpers(Zikula_Event $event)
    {
        ...
        $helpers->add(
            array(
                'module' => 'MUPolls',
                'type'   => 'javascript',
                'path'   => 'modules/MUPolls/javascript/MUPolls_finder.js'
            )
        );
    }
    ...
    public static function getTinyMcePlugins(Zikula_Event $event)
    {
        ...
        $plugins->add(
            array(
                'name' => 'mupolls',
                'path' => 'modules/MUPolls/docs/scribite/plugins/TinyMce/plugins/mupolls/editor_plugin.js'
            )
        );
    }
    ...
    public static function getCKEditorPlugins(Zikula_Event $event)
    {
        ...
        $plugins->add(
            array(
                'name' => 'mupolls',
                'path' => 'modules/MUPolls/docs/scribite/plugins/CKEditor/vendor/ckeditor/plugins/mupolls/',
                'file' => 'plugin.js',
                'img'  => 'ed_mupolls.gif'
            )
        );
