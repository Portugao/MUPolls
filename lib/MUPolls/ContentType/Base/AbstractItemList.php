 ...
 */
abstract class MUPolls_ContentType_Base_AbstractItemList extends Content_AbstractContentType
{
    /**
    ...
    public function getTitle()
    {
        ...
        return __('MUPolls list view', $dom);
    }
    ...
    public function getDescription()
    {
        ...
        return __('Display list of MUPolls objects.', $dom);
    }
    ...
    public function loadData(&$data)
    {
        ...
        $controllerHelper = new MUPolls_Util_Controller($serviceManager);
    ...
    public function display()
    {
        ...
        $entityClass = 'MUPolls_Entity_' . ucfirst($this->objectType);
        $serviceManager = ServiceUtil::getManager();
        $entityManager = $serviceManager->getService('doctrine.entitymanager');
        $repository = $entityManager->getRepository($entityClass);
    
        // ensure that the view does not look for templates in the Content module (#218)
        $this->view->toplevelmodule = 'MUPolls';
    
        $this->view->setCaching(Zikula_View::CACHE_ENABLED);
        // set cache id
        $component = 'MUPolls:' . ucfirst($this->objectType) . ':';
        $instance = '::';
    ...
    protected function getSortParam($repository)
    {
        ...
        if ($this->sorting == 'newest') {
            $idFields = ModUtil::apiFunc('MUPolls', 'selection', 'getIdFields', array('ot' => $this->objectType));
            if (count($idFields) == 1) {
    ...
    public function startEditing()
    {
        ...
        array_push($this->view->plugins_dir, 'modules/MUPolls/templates/plugins');
    }
}
