 ...
 */
abstract class MUPolls_ContentType_Base_AbstractItem extends Content_AbstractContentType
{
    ...
    public function getTitle()
    {
        ...
        return __('MUPolls detail view', $dom);
    }
    ...
    public function getDescription()
    {
        ...
        return __('Display or link a single MUPolls object.', $dom);
    }
    ...
    public function display()
    {
        if (null !== $this->id && !empty($this->displayMode)) {
            return ModUtil::func('MUPolls', 'external', 'display', $this->getDisplayArguments());
        }
