 ...
 */
class MUPolls_Api_Base_Mailz extends Zikula_AbstractApi
{
    /**
    ...
    public function getPlugins(array $args = array())
    {
        ...
        $plugins[] = array(
            'pluginid'      => 1,
            'module'        => 'MUPolls',
            'title'         => $this->__('3 newest polls'),
            'description'   => $this->__('A list of the three newest polls.')
        );
        $plugins[] = array(
            'pluginid'      => 2,
            'module'        => 'MUPolls',
            'title'         => $this->__('3 random polls'),
            'description'   => $this->__('A list of three random polls.')
        );
    ...
    public function getContent(array $args = array())
    {
        ...
        $idFields = ModUtil::apiFunc('MUPolls', 'selection', 'getIdFields', array('ot' => $objectType));
        ...
        list($entities, $objectCount) = ModUtil::apiFunc('MUPolls', 'selection', 'getEntitiesPaginated', $selectionArgs);
    
        $templateType = $args['contenttype'] == 't' ? 'text' : 'html';
    
        $view = Zikula_View::getInstance('MUPolls', true);
        ...
        return $view->fetch('mailz/itemlist_poll_' . $templateType . '.tpl');
    }
}
