 ...
 */
class MUPolls_Api_Base_Search extends Zikula_AbstractApi
{
    /**
    ...
    public function options(array $args = array())
    {
        ...
        $view->assign('active_option', (!isset($args['active_option']) || isset($args['active']['active_option'])));
        $view->assign('active_poll', (!isset($args['active_poll']) || isset($args['active']['active_poll'])));
        $view->assign('active_vote', (!isset($args['active_vote']) || isset($args['active']['active_vote'])));
