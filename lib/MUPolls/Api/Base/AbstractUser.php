 ...
 */
abstract class MUPolls_Api_Base_AbstractUser extends Zikula_AbstractApi
{
    /**
    ...
    public function getLinks()
    {
        ...
        if (in_array('option', $allowedObjectTypes)
            ...
            $links[] = array(
                'url' => ModUtil::url($this->name, 'user', 'view', array('ot' => 'option')),
        ...
        if (in_array('vote', $allowedObjectTypes)
            ...
            $links[] = array(
                'url' => ModUtil::url($this->name, 'user', 'view', array('ot' => 'vote')),
                 'text' => $this->__('Votes'),
    ...
    public function encodeurl(array $args = array())
    {
        ...
        $routerFacade = new MUPolls_RouterFacade();
        ...
        $modInfo = ModUtil::getInfoFromName('MUPolls');
    ...
    public function decodeurl(array $args = array())
    {
        ...
        $funcs = array('index', 'view', 'display', 'edit', 'delete', 'view', 'display', 'edit', 'delete');
