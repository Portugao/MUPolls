...
namespace MU\PollsModule\HookProvider\Base;
 ...
 */
abstract class AbstractPollUiHooksProvider implements HookProviderInterface
{
    use ServiceIdTrait;
    ...
    /**
     * PollUiHooksProvider constructor.
     *
    ...
    {
        return $this->translator->__('Poll ui hooks provider');
    }
    ...
    {
        return 'provider.mupollsmodule.ui_hooks.polls';
    }
    ...
    {
        return 'MU\PollsModule\Entity\HookAssignmentEntity';
    }
    ...
    protected function selectAssignedEntities(Hook $hook)
    {
        ...
        $entities = $this->entityFactory->getRepository('poll')->selectByIdList($assignedIds);
    ...
    protected function renderDisplayHookResponse(Hook $hook, $context)
    {
        ...
        $template = '@MUPollsModule/Poll/includeDisplayItemListMany.html.twig';
