...
namespace MU\PollsModule\Form\Plugin\Base;
...
class AbstractItemSelector extends Zikula_Form_Plugin_TextInput implements ContainerAwareInterface
{
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        if ($firstTime) {
            ...
            $jsAssetBag->add($assetHelper->resolve('@MUPollsModule:js/MUPollsModule.js'));
            $jsAssetBag->add($assetHelper->resolve('@MUPollsModule:js/MUPollsModule.ItemSelector.js'));
        ...
        if (!$permissionApi->hasPermission('MUPollsModule:' . ucfirst($this->objectType) . ':', '::', ACCESS_COMMENT)) {
            return false;
        }
    ...
    public function decode(Zikula_Form_View $view)
    {
        ...
        $this->objectType = $request->request->get('MUPollsModule_objecttype', 'poll');
