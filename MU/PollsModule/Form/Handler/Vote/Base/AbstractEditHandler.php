...
namespace MU\PollsModule\Form\Handler\Vote\Base;

use MU\PollsModule\Form\Handler\Common\EditHandler;
use MU\PollsModule\Form\Type\VoteType;
...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    public function processForm(array $templateParameters = [])
    {
        ...
        if ($this->templateParameters['mode'] == 'create') {
            if (!$this->modelHelper->canBeCreated($this->objectType)) {
                $this->request->getSession()->getFlashBag()->add('error', $this->__('Sorry, but you can not create the vote yet as other items are required which must be created before!'));
    ...
    {
        return $this->formFactory->create(VoteType::class, $this->entityRef, $this->getFormOptions());
    }
    ...
    protected function getRedirectCodes()
    {
        ...
        // user index page of vote area
        $codes[] = 'userIndex';
        // admin index page of vote area
        $codes[] = 'adminIndex';
        // user list of votes
        $codes[] = 'userView';
        // admin list of votes
        $codes[] = 'adminView';
        // user list of own votes
        $codes[] = 'userOwnView';
        // admin list of own votes
        $codes[] = 'adminOwnView';
        // user detail page of treated vote
        $codes[] = 'userDisplay';
        // admin detail page of treated vote
        $codes[] = 'adminDisplay';
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'MUPollsModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'vote', 'id' => $entity->getKey(), 'errorMessage' => $exception->getMessage()];
