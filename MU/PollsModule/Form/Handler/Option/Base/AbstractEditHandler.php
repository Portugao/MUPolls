...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    protected function createForm()
    {
        ...
        return $this->formFactory->create('MU\PollsModule\Form\Type\OptionType', $this->entityRef, $options);
    }
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'MUPollsModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'option', 'id' => $entity->createCompositeIdentifier(), 'errorMessage' => $e->getMessage()];
    ...
    protected function getRedirectUrl($args)
    {
        ...
        if ($this->request->getSession()->has('mupollsmodule' . $this->objectTypeCapital . 'Referer')) {
            $this->request->getSession()->del('mupollsmodule' . $this->objectTypeCapital . 'Referer');
        }
