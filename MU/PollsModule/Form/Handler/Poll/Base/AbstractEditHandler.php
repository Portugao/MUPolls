...
namespace MU\PollsModule\Form\Handler\Poll\Base;
...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    public function processForm(array $templateParameters)
    {
        ...
        if ($this->templateParameters['mode'] == 'create') {
            if (!$this->modelHelper->canBeCreated($this->objectType)) {
                $this->request->getSession()->getFlashBag()->add('error', $this->__('Sorry, but you can not create the poll yet as other items are required which must be created before!'));
    ...
    protected function createForm()
    {
        ...
        return $this->formFactory->create('MU\PollsModule\Form\Type\PollType', $this->entityRef, $options);
    }
    ...
    protected function getRedirectCodes()
    {
        ...
        // user index page of poll area
        $codes[] = 'userIndex';
        // admin index page of poll area
        $codes[] = 'adminIndex';
        // user list of polls
        $codes[] = 'userView';
        // admin list of polls
        $codes[] = 'adminView';
        // user list of own polls
        $codes[] = 'userOwnView';
        // admin list of own polls
        $codes[] = 'adminOwnView';
        // user detail page of treated poll
        $codes[] = 'userDisplay';
        // admin detail page of treated poll
        $codes[] = 'adminDisplay';
    ...
    protected function getDefaultMessage($args, $success = false)
    {
        ...
        switch ($args['commandName']) {
            case 'submit':
                if ($this->templateParameters['mode'] == 'create') {
                    $message = $this->__('Done! Poll created.');
                } else {
                    $message = $this->__('Done! Poll updated.');
                }
                break;
            case 'delete':
                $message = $this->__('Done! Poll deleted.');
                break;
            default:
                $message = $this->__('Done! Poll updated.');
                break;
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'MUPollsModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'poll', 'id' => $entity->createCompositeIdentifier(), 'errorMessage' => $e->getMessage()];
