...
use MU\PollsModule\Form\Type\PollType;
...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'MUPollsModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'poll', 'id' => $entity->getKey(), 'errorMessage' => $exception->getMessage()];
