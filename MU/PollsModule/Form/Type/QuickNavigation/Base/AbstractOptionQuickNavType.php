...
/**
 * Option quick navigation form type base class.
 */
abstract class AbstractOptionQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    /**
     * OptionQuickNavType constructor.
     *
    ...
    {
        $listEntries = $this->listHelper->getEntries('option', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    {
        return 'mupollsmodule_optionquicknav';
    }
}
