...
abstract class AbstractPollQuickNavType extends AbstractType
{
    ...
    {
        $builder->add('multiple', 'Symfony\Component\Form\Extension\Core\Type\ChoiceType', [
        ...
        $builder->add('inFrontend', 'Symfony\Component\Form\Extension\Core\Type\ChoiceType', [
