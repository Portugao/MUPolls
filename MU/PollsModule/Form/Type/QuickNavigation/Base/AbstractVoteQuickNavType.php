...
/**
 * Vote quick navigation form type base class.
 */
abstract class AbstractVoteQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    {
        $listEntries = $this->listHelper->getEntries('vote', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    {
        return 'mupollsmodule_votequicknav';
    }
}
