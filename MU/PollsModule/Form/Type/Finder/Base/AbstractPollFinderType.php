...
/**
 * Poll finder form type base class.
 */
abstract class AbstractPollFinderType extends AbstractType
{
    use TranslatorTrait;
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options = [])
    {
        $builder->add('pasteAs', ChoiceType::class, [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Relative link to the poll') => 1,
                $this->__('Absolute url to the poll') => 2,
                $this->__('ID of poll') => 3
            ],
            'multiple' => false,
            'expanded' => false
        ]);
    ...
    {
        return 'mupollsmodule_pollfinder';
    }
