...
namespace MU\PollsModule\Form\Type\Finder\Base;
...
/**
 * Option finder form type base class.
 */
abstract class AbstractOptionFinderType extends AbstractType
{
    use TranslatorTrait;
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options)
    {
        $builder->add('pasteAs', ChoiceType::class, [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Relative link to the option') => 1,
                $this->__('Absolute url to the option') => 2,
                $this->__('ID of option') => 3
            ],
    ...
    public function addSortingFields(FormBuilderInterface $builder, array $options)
    {
        $builder
            ->add('sort', ChoiceType::class, [
                ...
                'choices' => [
                    $this->__('Title') => 'title',
                    $this->__('Color of option') => 'colorOfOption',
                    $this->__('Id of poll') => 'idOfPoll',
    ...
    {
        return 'mupollsmodule_optionfinder';
    }
