...
/**
 * Vote finder form type base class.
 */
abstract class AbstractVoteFinderType extends AbstractType
{
    use TranslatorTrait;
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options = [])
    {
        $builder->add('pasteAs', ChoiceType::class, [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Relative link to the vote') => 1,
                $this->__('Absolute url to the vote') => 2,
                $this->__('ID of vote') => 3
            ],
            'multiple' => false,
            'expanded' => false
        ]);
    ...
    public function addSortingFields(FormBuilderInterface $builder, array $options = [])
    {
        $builder
            ->add('sort', ChoiceType::class, [
                ...
                'empty_data' => '',
                'choices' => [
                    $this->__('Id of option') => 'idOfOption',
    ...
    {
        return 'mupollsmodule_votefinder';
    }
