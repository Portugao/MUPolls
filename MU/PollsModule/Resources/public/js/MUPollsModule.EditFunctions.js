 ...
 */
function mUPollsInitUserField(fieldName, getterName)
{
    ...
    jQuery('#' + fieldName + 'Selector').typeahead({
        ...
        source: function (query, syncResults, asyncResults) {
            ...
            jQuery.getJSON(Routing.generate('mupollsmodule_ajax_' + getterName.toLowerCase(), { fragment: query }), function( data ) {
 ...
 */
function mUPollsResetDateField(fieldName)
{
...
function mUPollsInitDateField(fieldName)
{
    jQuery('#' + fieldName + 'ResetVal').click( function (event) {
        ...
        mUPollsResetDateField(fieldName);
    }).removeClass('hidden');
}
