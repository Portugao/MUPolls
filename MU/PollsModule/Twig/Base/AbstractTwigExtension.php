...
namespace MU\PollsModule\Twig\Base;
...
abstract class AbstractTwigExtension extends Twig_Extension
{
    ...
    {
        return [
            new \Twig_SimpleFilter('mupollsmodule_listEntry', [$this, 'getListEntry']),
            new \Twig_SimpleFilter('mupollsmodule_formattedTitle', [$this, 'getFormattedEntityTitle']),
            new \Twig_SimpleFilter('mupollsmodule_objectState', [$this, 'getObjectState'], ['is_safe' => ['html']])
        ];
    }
    
    /**
     * The mupollsmodule_objectState filter displays the name of a given object's workflow state.
     * Examples:
     *    {{ item.workflowState|mupollsmodule_objectState }}        {# with visual feedback #}
     *    {{ item.workflowState|mupollsmodule_objectState(false) }} {# no ui feedback #}
     *
    ...
    /**
     * The mupollsmodule_listEntry filter displays the name
     * or names for a given list item.
     * Example:
     *     {{ entity.listField|mupollsmodule_listEntry('entityName', 'fieldName') }}
     *
    ...
    /**
     * The mupollsmodule_objectTypeSelector function provides items for a dropdown selector.
     *
     * @return string The output of the plugin
     */
    ...
    /**
     * The mupollsmodule_templateSelector function provides items for a dropdown selector.
     *
     * @return string The output of the plugin
     */
    ...
    /**
     * The mupollsmodule_formattedTitle filter outputs a formatted title for a given entity.
     * Example:
     *     {{ myPost|mupollsmodule_formattedTitle }}
     *
