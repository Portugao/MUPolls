...
namespace MU\PollsModule\Block\Base;

use Zikula\BlocksModule\AbstractBlockHandler;
use Zikula\Core\AbstractBundle;
use MU\PollsModule\Block\Form\Type\ItemListBlockType;
...
abstract class AbstractItemListBlock extends AbstractBlockHandler
{
    ...
    public function display(array $properties)
    {
        ...
        if (!$this->hasPermission('MUPollsModule:ItemListBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return false;
        }
        ...
        // create query
        $orderBy = $this->get('mu_polls_module.model_helper')->resolveSortParameter($objectType, $properties['sorting']);
        ...
        if (empty($properties['title'])) {
            $properties['title'] = $this->__('MUPollsModule items');
        }
        ...
        $templateParameters = $this->get('mu_polls_module.controller_helper')->addTemplateParameters($properties['objectType'], $templateParameters, 'block', []);
    ...
    {
        return '@MUPollsModule/Block/itemlist_modify.html.twig';
    }
