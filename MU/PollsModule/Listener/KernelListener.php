...
namespace MU\PollsModule\Listener;

use MU\PollsModule\Listener\Base\AbstractKernelListener;
...
class KernelListener extends AbstractKernelListener
{
    ...
    public function onRequest(GetResponseEvent $event)
    {
        ...
        // $testMessage = 'Hello from polls app';
        // $event->getRequest()->attributes->set('MUPollsModule_test', $testMessage);
    ...
    public function onResponse(FilterResponseEvent $event)
    {
        ...
        // $testMessage = $event->getRequest()->attributes->get('MUPollsModule_test');
        // now $testMessage should be: 'Hello from polls app'
    ...
    public function onException(GetResponseForExceptionEvent $event)
    {
        ...
        //     || $exception instanceof MySpecialExceptionInterface) {
            ...
            // $message = sprintf(
            //     'polls App Error says: %s with code: %s',
