 ...
 */
abstract class AbstractVoteRepository extends EntityRepository
{
    
    /**
     * @var string The default sorting field/expression
     */
    protected $defaultSortingField = 'idOfOption';
    ...
    public function truncateTable(LoggerInterface $logger)
    {
        ...
        $qb->delete('MU\PollsModule\Entity\VoteEntity', 'tbl');
        $query = $qb->getQuery();
    
        $query->execute();
    
        $logArgs = ['app' => 'MUPollsModule', 'entity' => 'vote'];
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApi $currentUserApi)
    {
        ...
        $qb = $this->getEntityManager()->createQueryBuilder();
        $qb->update('MU\PollsModule\Entity\VoteEntity', 'tbl')
        ...
        $logArgs = ['app' => 'MUPollsModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'votes', 'userid' => $userId];
    ...
    protected function getCountQuery($where = '', $useJoins = false)
    {
        ...
        $qb = $this->getEntityManager()->createQueryBuilder();
        $qb->select($selection)
           ->from('MU\PollsModule\Entity\VoteEntity', 'tbl');
     ...
     * @param integer $excludeId  Id of votes to exclude (optional)
     *
