 ...
 */
abstract class AbstractOptionRepository extends EntityRepository
{
    ...
    public function truncateTable(LoggerInterface $logger)
    {
        ...
        $qb->delete('MU\PollsModule\Entity\OptionEntity', 'tbl');
        $query = $qb->getQuery();
    
        $query->execute();
    
        $logArgs = ['app' => 'MUPollsModule', 'entity' => 'option'];
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApi $currentUserApi)
    {
        ...
        $qb = $this->getEntityManager()->createQueryBuilder();
        $qb->update('MU\PollsModule\Entity\OptionEntity', 'tbl')
        ...
        $logArgs = ['app' => 'MUPollsModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'options', 'userid' => $userId];
    ...
    protected function getCountQuery($where = '', $useJoins = false)
    {
        ...
        $qb = $this->getEntityManager()->createQueryBuilder();
        $qb->select($selection)
           ->from('MU\PollsModule\Entity\OptionEntity', 'tbl');
     ...
     * @param integer $excludeId  Id of options to exclude (optional)
     *
    ...
    public function getQueryFromBuilder(QueryBuilder $qb)
    {
        ...
        if ($featureActivationHelper->isEnabled(FeatureActivationHelper::TRANSLATIONS, 'option')) {
