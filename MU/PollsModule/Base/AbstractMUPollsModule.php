...
namespace MU\PollsModule\Base {
     ...
     * Module base class.
     */
    abstract class AbstractMUPollsModule extends AbstractModule
    {
    }
}
...
namespace {
    ...
    class MUPollsModule_ContentType_ItemList extends \MU\PollsModule\ContentType\ItemList {
    }
    class MUPollsModule_ContentType_Item extends \MU\PollsModule\ContentType\Item {
    }
}
