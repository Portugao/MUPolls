...
abstract class AbstractOptionController extends AbstractController
{
     ...
     * @ParamConverter("option", class="MUPollsModule:OptionEntity", options = {"id" = "id", "repository_method" = "selectById"})
    ...
    protected function displayInternal(Request $request, OptionEntity $option, $isAdmin = false)
    {
        ...
        $instanceId = $option->createCompositeIdentifier();
    ...
    protected function deleteInternal(Request $request, OptionEntity $option, $isAdmin = false)
    {
        ...
        $logArgs = ['app' => 'MUPollsModule', 'user' => $this->get('zikula_users_module.current_user')->get('uname'), 'entity' => 'option', 'id' => $option->createCompositeIdentifier()];
        ...
        $form = $this->createForm('MU\PollsModule\Form\DeleteEntityType', $option);
        
        if ($form->handleRequest($request)->isValid()) {
            if ($form->get('delete')->isClicked()) {
                $hookHelper = $this->get('mu_polls_module.hook_helper');
                // Let any hooks perform additional validation actions
                $validationHooksPassed = $hookHelper->callValidationHooks($option, 'validate_delete');
                if ($validationHooksPassed) {
                    ...
                    $hookHelper->callProcessHooks($option, 'process_delete', null);
    ...
    protected function handleSelectedEntriesActionInternal(Request $request, $isAdmin = false)
    {
        ...
        foreach ($items as $itemId) {
            ...
            try {
                ...
                $logger->error('{app}: User {user} tried to execute the {action} workflow action for the {entity} with id {id}, but failed. Error details: {errorMessage}.', ['app' => 'MUPollsModule', 'user' => $userName, 'action' => $action, 'entity' => 'option', 'id' => $itemId, 'errorMessage' => $e->getMessage()]);
            }
            ...
            if ($action != 'delete') {
                ...
                $url = new RouteUrl('mupollsmodule_option_' . /*($isAdmin ? 'admin' : '') . */'display', $urlArgs);
            }
