...
namespace MU\PollsModule\ContentType\Base;
...
abstract class AbstractItemList extends \Content_AbstractContentType implements ContainerAwareInterface
{
    ...
    {
        return $this->container->get('translator.default')->__('MUPollsModule list view');
    }
    ...
    {
        return $this->container->get('translator.default')->__('Display list of MUPollsModule objects.');
    }
    ...
    {
        $controllerHelper = $this->container->get('mu_polls_module.controller_helper');
    ...
    {
        $repository = $this->container->get('mu_polls_module.entity_factory')->getRepository($this->objectType);
        $permissionApi = $this->container->get('zikula_permissions_module.api.permission');
    
        // create query
        $orderBy = $this->container->get('mu_polls_module.model_helper')->resolveSortParameter($this->objectType, $this->sorting);
        ...
        $templateParameters = $this->container->get('mu_polls_module.controller_helper')->addTemplateParameters($this->objectType, $templateParameters, 'contentType', []);
    ...
    protected function getDisplayTemplate()
    {
        ...
        foreach ($templateOptions as $templatePath) {
            if ($templating->exists('@MUPollsModule/' . $templatePath)) {
                $template = '@MUPollsModule/' . $templatePath;
                break;
            }
        }
    ...
    public function startEditing()
    {
        ...
        $this->view->toplevelmodule = 'MUPollsModule';
    
        // ensure our custom plugins are loaded
        array_push($this->view->plugins_dir, 'modules/MU/PollsModule/Resources/views/plugins');
    }
