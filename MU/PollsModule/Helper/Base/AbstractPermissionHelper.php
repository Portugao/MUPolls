...
abstract class AbstractPermissionHelper implements ContainerAwareInterface
{
    ...
    public function hasEntityPermission($entity, $permissionLevel, $userId = null)
    {
        ...
        return $this->permissionApi->hasPermission('MUPollsModule:' . ucfirst($objectType) . ':', $instance, $permissionLevel, $userId);
    }
    ...
    {
        return $this->permissionApi->hasPermission('MUPollsModule:' . ucfirst($objectType) . ':', '::', $permissionLevel, $userId);
    }
    ...
    {
        return $this->permissionApi->hasPermission('MUPollsModule::', '::', $permissionLevel, $userId);
    }
