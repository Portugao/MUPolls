...
abstract class AbstractViewHelper
{
    ...
    public function getViewTemplate($type, $func)
    {
        ...
        $template = '@MUPollsModule/' . ucfirst($type) . '/' . $func;
    ...
    {
        $extensions = [];
        $hasAdminAccess = $this->permissionApi->hasPermission('MUPollsModule:' . ucfirst($type) . ':', '::', ACCESS_ADMIN);
        if ($func == 'view') {
            if ($hasAdminAccess) {
                $extensions = ['rss'];
            } else {
    ...
    protected function processPdf(array $templateParameters = [], $template)
    {
        ...
        $output = $this->twig->render('@MUPollsModule/includePdfHeader.html.twig') . $output . '</body></html>';
