...
abstract class AbstractCollectionFilterHelper
{
    ...
    public function getViewQuickNavParameters($objectType = '', $context = '', array $args = [])
    {
        ...
        if ($objectType == 'option') {
            return $this->getViewQuickNavParametersForOption($context, $args);
        }
        if ($objectType == 'poll') {
            return $this->getViewQuickNavParametersForPoll($context, $args);
        }
        if ($objectType == 'vote') {
            return $this->getViewQuickNavParametersForVote($context, $args);
        }
    ...
    {
        if ($objectType == 'option') {
            return $this->addCommonViewFiltersForOption($qb);
        }
        if ($objectType == 'poll') {
            return $this->addCommonViewFiltersForPoll($qb);
        }
        if ($objectType == 'vote') {
            return $this->addCommonViewFiltersForVote($qb);
        }
    ...
    public function applyDefaultFilters($objectType, QueryBuilder $qb, array $parameters = [])
    {
        ...
        if ($objectType == 'poll') {
            return $this->applyDefaultFiltersForPoll($qb, $parameters);
        }
        if ($objectType == 'vote') {
            return $this->applyDefaultFiltersForVote($qb, $parameters);
        }
     ...
     * @return QueryBuilder Enriched query builder instance
     */
    protected function addCommonViewFiltersForOption(QueryBuilder $qb)
    {
        if (null === $this->request) {
            return $qb;
        }
        ...
        $parameters = $this->getViewQuickNavParametersForOption();
        ...
        $qb = $this->applyDefaultFiltersForOption($qb, $parameters);
     ...
     * @return QueryBuilder Enriched query builder instance
     */
    protected function addCommonViewFiltersForPoll(QueryBuilder $qb)
    {
        if (null === $this->request) {
            return $qb;
        }
        ...
        $parameters = $this->getViewQuickNavParametersForPoll();
        foreach ($parameters as $k => $v) {
            if (in_array($k, ['q', 'searchterm'])) {
                // quick search
                if (!empty($v)) {
        ...
        $qb = $this->applyDefaultFiltersForPoll($qb, $parameters);
     ...
     * @return QueryBuilder Enriched query builder instance
     */
    protected function addCommonViewFiltersForVote(QueryBuilder $qb)
    {
        if (null === $this->request) {
            return $qb;
        }
        ...
        $parameters = $this->getViewQuickNavParametersForVote();
        foreach ($parameters as $k => $v) {
            if (in_array($k, ['q', 'searchterm'])) {
                // quick search
                if (!empty($v)) {
        ...
        $qb = $this->applyDefaultFiltersForVote($qb, $parameters);
    ...
    protected function applyDefaultFiltersForOption(QueryBuilder $qb, array $parameters = [])
    {
        ...
        $routeName = $this->request->get('_route');
        $isAdminArea = false !== strpos($routeName, 'mupollsmodule_option_admin');
        if ($isAdminArea) {
            return $qb;
        }
    ...
    protected function applyDefaultFiltersForPoll(QueryBuilder $qb, array $parameters = [])
    {
        ...
        $routeName = $this->request->get('_route');
        $isAdminArea = false !== strpos($routeName, 'mupollsmodule_poll_admin');
        if ($isAdminArea) {
            return $qb;
        }
    ...
    protected function applyDefaultFiltersForVote(QueryBuilder $qb, array $parameters = [])
    {
        ...
        $routeName = $this->request->get('_route');
        $isAdminArea = false !== strpos($routeName, 'mupollsmodule_vote_admin');
        if ($isAdminArea) {
            return $qb;
        }
    ...
    public function addSearchFilter($objectType, QueryBuilder $qb, $fragment = '')
    {
        ...
        if ($objectType == 'option') {
            ...
            $filters[] = 'tbl.colorOfOption LIKE :searchColorOfOption';
            $parameters['searchColorOfOption'] = '%' . $fragment . '%';
            $filters[] = 'tbl.idOfPoll = :searchIdOfPoll';
            $parameters['searchIdOfPoll'] = $fragment;
        }
        if ($objectType == 'poll') {
            ...
            $filters[] = 'tbl.dateOfStart = :searchDateOfStart';
            $parameters['searchDateOfStart'] = $fragment;
            $filters[] = 'tbl.dateOfEnd = :searchDateOfEnd';
            $parameters['searchDateOfEnd'] = $fragment;
        }
        if ($objectType == 'vote') {
            $filters[] = 'tbl.idOfOption = :searchIdOfOption';
            $parameters['searchIdOfOption'] = $fragment;
            $filters[] = 'tbl.idOfPoll = :searchIdOfPoll';
            $parameters['searchIdOfPoll'] = $fragment;
        }
